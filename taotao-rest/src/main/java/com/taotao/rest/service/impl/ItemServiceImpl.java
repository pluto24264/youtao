...
/*
	...
	private String REDIS_ITEM_EXPIRE_KEY;
*/
	@Override
	public TaotaoResult getItemBaseInfo(long itemId) {
		...
		try {
			...
			// 设置key的有效期
//			jedisClient.expire(redisKey, Integer.parseInt(REDIS_ITEM_EXPIRE_KEY));
			jedisClient.expire(redisKey, 86400);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return TaotaoResult.ok(item);
